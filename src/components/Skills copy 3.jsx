  ...
  return (
    <section id="skills" className="min-h-screen flex flex-col items-center justify-center bg-[#1B263B] text-white px-6">
      ...
      {user ? (
        ...
        // <button onClick={signIn} className="mb-4 px-4 py-2 bg-blue-500 rounded text-white">Admin Login</button>
// // ----------------------------------------------------------------       
//  <button
//   onClick={signIn}
//   className="mb-4 px-2 py-1 text-sm bg-blue-500 text-white rounded opacity-0 hover:opacity-100 transition"
// >
//   Admin Login
// </button>
// ----------------------------------------------------------------
...
//<button
 // onClick={signIn}
//  className="fixed bottom-4 right-4 mb-4 px-2 py-1 text-sm bg-blue-500 text-white rounded opacity-50 hover:opacity-100 transition"
//>
 // Admin Login
//</button>
